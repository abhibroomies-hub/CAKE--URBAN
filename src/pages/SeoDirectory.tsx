...
export default function SeoDirectory() {
  ...
  const allGeneratedUrls = useMemo(() => {
    ...
    // 25 localities * short keywords list = combinations! (NEW)
    const shortKeywords = [
      // Original standard
      ...
      // CRISP SHORT KEYWORDS (as requested)
      { template: 'cake-[loc]', title: 'Cake in [name]', desc: 'Premium custom eggless cakes delivered fresh to your doorstep in [name], [city] within 30-45 minutes.' },
      { template: 'cake-shop-[loc]', title: 'Cake Shop in [name]', desc: 'Order from the highest-rated pure veg eggless cake shop in [name], [city]. Online bakery orders live.' },
      { template: 'bento-cake-[loc]', title: 'Bento Cake in [name]', desc: 'Delicious mini 250g bento cakes, lunchbox cakes and custom message cakes in [name], [city] starting from ₹299.' },
      { template: 'eggless-cake-[loc]', title: 'Eggless Cake in [name]', desc: '100% vegetarian eggless chocolate, vanilla, and pineapple cakes prepared in separate ovens in [name], [city].' },
      { template: 'photo-cake-[loc]', title: 'Photo Cake in [name]', desc: 'Custom edible photo print cakes, picture birthday cakes and personalized anniversary cakes in [name], [city].' },
      { template: 'birthday-cake-[loc]', title: 'Birthday Cake in [name]', desc: 'Order standard custom kids birthday theme cakes, cartoon cakes, and tiered cakes in [name], [city].' },
      { template: 'anniversary-cake-[loc]', title: 'Anniversary Cake in [name]', desc: 'Celebrate with romantic red velvet, rose cream, and premium chocolate anniversary cakes in [name], [city].' },
      { template: 'pastry-[loc]', title: 'Pastry in [name]', desc: 'Fresh chocolate truffle, red velvet, butterscotch, and fruit pastries in [name], [city] from our live kitchen.' },

      // HINDI / HINGLISH KEYWORDS (as requested)
      { template: 'sabse-achha-cake-[loc]', title: 'Sabse Achha Cake in [name]', desc: 'Pure [name], [city] me sabse achha aur fresh eggless cake order karein. Best taste, real cream, home delivery.' },
      { template: 'cake-delivery-ghar-par-[loc]', title: 'Cake Delivery Ghar Par in [name]', desc: 'Ghar baithe online cake order karein aur 30 minute me delivery paayein [name], [city] me. Safe and contactless.' },
      { template: 'birthday-ke-liye-cake-[loc]', title: 'Birthday ke liye Cake in [name]', desc: 'Bachon aur badon ke birthday party ke liye sabse swadisht aur sundar cake shop in [name], [city]. Custom designs.' },
      { template: 'sabse-sasta-cake-[loc]', title: 'Sasta aur Best Cake in [name]', desc: 'Aapke budget me sabse sasta aur swadisht pure eggless cake delivery in [name], [city]. Starting from ₹250 only.' },
      { template: 'photo-wala-cake-[loc]', title: 'Photo wala Cake in [name]', desc: 'Apni pasand ki photo lagakar custom picture printed cake online mangaen in [name], [city]. High quality edible sheets.' },
      { template: 'meetha-cake-[loc]', title: 'Meetha Cake in [name]', desc: 'Fresh eggless meetha cake online order karein [name], [city] me. Chocolate, Pineapple aur Butterscotch variants.' },
      { template: 'pure-veg-cake-[loc]', title: 'Pure Veg Cake in [name]', desc: '100% shuddh shakahari pure veg eggless cake shop near me in [name], [city]. Alag kitchen me tayaar.' },
      { template: 'eggless-cake-shop-[loc]', title: 'Eggless Cake Shop near me in [name]', desc: 'Dhoond rahe hain eggless cake shop near [name], [city]? Cake Urban par swadisht shakahari cakes milega.' },
      { template: 'online-cake-mangaen-[loc]', title: 'Online Cake Mangaen in [name]', desc: 'Kuch hi minutes me online cake mangaen [name], [city] me. Direct bakery kitchen se fresh delivery.' }
    ];
